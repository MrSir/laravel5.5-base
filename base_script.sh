...
# create db #
mysql -uroot -pTest1234 -e "CREATE DATABASE laravel55 CHARSET utf8 COLLATE utf8_unicode_ci;"

# add permissions to root for tables #
mysql -uroot -pTest1234 -e "GRANT ALL PRIVILEGES ON laravel55.* TO 'root'@'localhost';"
